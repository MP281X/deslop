...
| Unverified | No real thread has run this version. The next real Astra, Fable, or Opus 5.5 threads are the evaluation.                                                               |
...
| One delivery: commit, push, attached screenshots, body, one pipeline wait | 6 git runs and separate screenshot passes; `gh`/`glab --attach` replace API uploads                                                |
