...
Report one line per item, outcome first, within about 500 tokens, omitting empty fields, with no diff, repeated brief, narration, or list of what was checked:
...
Bug fixed: <path:line> — <bug> — <evidence the engineering skill's bug rule names>
Kept: <path:line> — <behavior kept because it may be intentional> — <why>
