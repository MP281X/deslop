...
Do not delegate or change product code. Preserve defect evidence and remove only artifacts created by this run. Report one line per criterion, omitting empty fields:
