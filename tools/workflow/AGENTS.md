...
- `assets/codex` owns the primary configuration and specialist roles. Primary owns user intent, material decisions, and delegation; each specialist owns one bounded responsibility and its terminal result.
